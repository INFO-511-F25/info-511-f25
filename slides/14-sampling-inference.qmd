...
# Plot comparison of population and sampling distributions stacked row-wise
...
a single sample's population mean, which has a **t-distribution with n-1 degrees of freedom**:
