...
How does **environmental stability** correlate with **human freedom indices** in different countries, and what trends can be observed?

::: columns
::: {.column width="50%"}
![](images/environmental-stability.jpeg){fig-align="center" width="919"}
:::
...
> Note that this will take us **two** lectures to answer.
:::
...
Here is the equivalent recap of logical operators in Python:
...
# To be continued... <br> ...in Week 9 🫠 {style="text-align:center;"}
