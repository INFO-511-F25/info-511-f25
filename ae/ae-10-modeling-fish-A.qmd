...
-   **Demo:** We can fit more models than just a straight line. Change the following code below to read `lowess=True`. What is different from the plot created before?
