...
Then, one team member should edit the document Markdown cell by adding the team name to the `subtitle` field and adding the names of the team members contributing to lab to the `author` field.
