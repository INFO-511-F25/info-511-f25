...
Then, they should write the answer to Part 2 (up to question 5).
All others should contribute to the discussion but only one person should type up the answer, render the document, commit, and push to GitHub.
All others should **not** touch the document.
:::
...
::: callout-important
After the team member working on Part 2 (up to question 5) renders, commits, and pushes, another team member should pull their changes and render the document.
Then, they should write the answer to Part 2 (questions 5-7).
All others should contribute to the discussion but only one person should type up the answer, render the document, commit, and push to GitHub.
All others should **not** touch the document.
:::
...
a.  Create a new variable `transformed_parsim` that is calculated as `math.log(parsim/(1-parsim))`.
    Add this variable to your data frame.

::: callout-note
`math.log()` in Python represents the **nautral log**.
:::
...
::: callout-important
After the team member working on Part 2 (questions 5-7) renders, commits, and pushes, another team member should pull their changes and render the document.
Then, they should write the answer to Part 3 (question 8).
All others should contribute to the discussion but only one person should type up the answer, render the document, commit, and push to GitHub.
All others should **not** touch the document.
:::
...
::: callout-important
After the team member working on Part 3 (question 8) renders, commits, and pushes, another team member should pull their changes and render the document.
Then, they should write the answer to Part 3 (questions 9-10).
All others should contribute to the discussion but only one person should type up the answer, render the document, commit, and push to GitHub.
All others should **not** touch the document.
:::
