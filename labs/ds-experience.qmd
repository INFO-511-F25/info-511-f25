...
::: callout-important
Completion of the DS Experience counts as a replacement for one lab from Lab 01 to Lab 04.
Labs 05-07 need to be completed with your project team.
:::
...
There will be one *optional* data science experience assignment that will replace up to one lab grade (among labs 01-04).
...
You can email Professor Chism if there is an activity you’d like to do but you’re not sure if it qualifies for the statistics experience.
