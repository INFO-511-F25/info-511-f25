...
a.  Fill in the code below to create a two-way table that summarizes these data.
    ...
    survey_counts = pd.DataFrame({
        'age': ['18-49', '18-49', '18-49', '50+', '50+', '50+'],
        'vote': ['Donald Trump', 'Joe Biden', 'Undecided', 'Donald Trump', 'Joe Biden', 'Undecided'],
        'n': [238, 237, 507-238-237, 271, 228, 271+228-271-228]
    })

    survey_pivot = survey_counts.pivot(index='age', columns='vote', values='n')
    survey_pivot
    ```
