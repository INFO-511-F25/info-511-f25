...
You will be assessed based on five components: application exercises, labs, assignments, project, and teamwork.

### Application exercises

**Each due Friday the following week after assigned**
...
The content of the assignment will be related to the content in videos and reading assignments, lectures, application exercises, and labs.
...
The project will be completed individually, working through coda bench to meet a benchmark.
...
-   Labs may be submitted up to 2 days late.
...
-   **Saturday, March 8 - Sunday, March 16:** Spring recess
