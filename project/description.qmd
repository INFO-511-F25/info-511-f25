...
You should create some kind of compelling visualization(s) of this data in Python.
...
All analyses must be done in VSCode (or other IDE), using Python, and all components of the project **must be reproducible** (with the exception of the presentation).
...
Critically reviewing others' work is a crucial part of the scientific process, and INFO 511 is no exception.
